...
func All() []Command {
	return []Command{
		...
		{Group: "Calculations", Name: "close", Usage: "close <p1> <p2> <p3> ...", Description: "Report area, misclose distance and bearing, and closure accuracy for an ordered set of point IDs.", Examples: []string{"close 1 2 3", "close 10 11 12 10"}},
		...
		{Group: "Calculations", Name: "shift", Usage: "shift <base> [east=<delta>] [north=<delta>] [elev=<delta>]", Description: "Shift all project points and stored contour geometry by the supplied deltas.", Examples: []string{"shift 100 east=10", "shift 100 east=5 north=-2 elev=0.5"}},
